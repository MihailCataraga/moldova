      ...
      <div className='sec-2'>
        ...
        <div className='content'>
          <div className='subSec-1'>
            <div className='left'>
              <h4>Moldova: A look at its history, culture and identity</h4>
          ...
          <div className='subSec-2'>
            ...
            <div className='right'>
              <h4>Independence and the Road to Sovereignty</h4>
          ...
          <div className='subSec-3'>
            <div className='left'>
              <h4>The Constitution and Democratic Principles</h4>
